...
<form class="form-inline" >
  ...
  <div class="container">
    <div class="row">
        ...
        <div class="col-md-11"><input type="text" class="form-control" id="exampleInputName2" disabled="disabled" value="${memberVo.mTel1 }-${memberVo.mTel2 }-${memberVo.mTel3 }"></div>
        ...
        <div class="col-md-1" style="text-align: center;"><label for="exampleInputName2">우편번호</label></div>
        <div class="col-md-11">
    	<input type="text" class="form-control" id="exampleInputName2" disabled="disabled" style="width: 410px" value="${index[0] }">
        </div>
        <br>
        <div class="col-md-1" style="text-align: center;"><label for="exampleInputName2">기본주소</label></div>
        <div class="col-md-11">
    	<input type="text" class="form-control" id="exampleInputName2" disabled="disabled" style="width: 410px" value="${index[1] }">
        </div>
